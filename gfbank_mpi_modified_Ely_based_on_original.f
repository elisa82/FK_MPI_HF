...
c          write(19,*) 'Name of velocity model'
c          write(19,'(a)') vm_name
cc          write(19,*) 'Maximum, Minimum, and Step of Epicenter Depth'
cc          write(19,*) dep_max, dep_min, dep_step
cc          write(19,*)'Maximum, Minimum, and Step of Epicenter Distance'
cc          write(19,*) dist_max,dist_min,d_step
c          write(19,*)"Min, Step1 and N1, and Step2 and N2 of Depth" !JORGE new
c          write(19,*) dep_min, dep_step, int(nz-1), 20.00, int(0) !JORGE new
c          write(19,*)"Min, Step1 and N1, and Step2 and N2 of Epi Dist" !JORGE new
c          write(19,*) dist_min, d_step, int(nx-1), 20.00, int(0) !JORGE new
cc JORGE changed the whole write of the Green Bank info file
c          write(19,*)'The lnpt, dt, block_gg, t_cor'
c          write(19,*) lnpt,dt,block_gg,t_cor
c          write(19,*)'The name of file to store Green Bank'
c          write(19,'(a)') output
c          write(19,*)'The number of GFun in Distance and Depth'
c          write(19,*) nx,nz
c          write(19,*) 'Velocity Structure model'
c          write(19,*) nlayer,2
c          do k=1,nlayer
cc JORGE changed format of the Green_Bank.inf file to match syn1D specs
cc            write(19,193) thick(k),vp(k),vs(k),den(k),qp(k),qs(k)
c            write(19,*) thick(k),vp(k),vs(k),den(k),qp(k),qs(k)
c          enddo
c          close(19)
cc193       format(6f12.4)
        endif
